...
(function ($) {
    ...
    var section_zoom = function () {
        $(".tf-image-zoom").off("mouseover mouseleave").on("mouseover", function () {
    ...
    // Initialize all zoom functions
    var initAllZoom = function() {
        section_zoom();
        cusZoom();
        imageZoomMagnifier();
        imageZoomInner();
    ...
    // Expose reinit for SPA route changes
    window.reinitZoom = initAllZoom;
})(jQuery);
