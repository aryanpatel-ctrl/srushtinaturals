      ...
      <div className="modal-main">
        <div className="tf-rte">
          ...
          <div className="tf-page-size-chart-content">
            <div>
              <p className="h6 fw-medium mb-16 cl-text-main">Measuring Tips</p>
              <div className="title fw-medium">Bust</div>
              <p className="mb-12">Measure around the fullest part of your bust.</p>
              <div className="title fw-medium">Waist</div>
              <p className="mb-12">Measure around the narrowest part of your torso.</p>
              <div className="title fw-medium">Low Hip</div>
              <p className="mb-12">With your feet together measure around the fullest part of your
                hips/rear.
              </p>
            </div>
            <div>
              <img loading="lazy" width={270} height={270} src="/assets/images/section/size-chart.jpg" alt="Image" />
            </div>
          </div>
        </div>
      </div>
